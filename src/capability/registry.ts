...
export const CAPABILITIES: readonly CapabilityDescriptor[] = [
  ...
  { name: "shell_run", minProfile: "developer", risk: "execute", scope: "workspace", summary: "Run PowerShell through the common Tool Permission Broker; only explicitly allowed operations execute without confirmation." }
];
